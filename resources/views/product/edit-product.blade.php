...
<form action="{{route('product.update', $data->id)}}" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-8">
            <select class="form-control" name="tenan_id" required id="tenan">
                <option value="{{$data->tenan_id}}" disabled>{{$data->tenan->nama_tenan}}</option>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" id="nama_barang" placeholder="Masukkan Nama Barang" required name="nama_barang" value="{{$data->nama_barang}}">
        </div>
    </div>
    <div class="mb-3 row">
        ...
        <div class="col-sm-8">
            <select class="form-control" name="satuan" required id="satuan">
                <option value="{{$data->satuan}}" disabled >{{$data->satuan}}</option>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-8">
            <input type="number" class="form-control" id="harga_satuan" placeholder="Masukkan Harga Barang" required min="0" name="harga_satuan" value="{{$data->harga_satuan}}">
        </div>
    </div>
    <div class="mb-3 row">
        <label for="stok" class="col-sm-2 col-form-label">Stok Barang</label>
        <div class="col-sm-8">
            <input type="number" class="form-control" id="stok" placeholder="Masukkan Stok Barang" required min="0" name="stok" value="{{$data->stok}}">
        </div>
    </div>
